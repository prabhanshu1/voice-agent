...
class VoicePipelineAgent(utils.EventEmitter[EventTypes]):
    ...
    async def say(
        ...
        *,
        ...
        """
        print("within voicePipelineAgent: source: ", source)
        ...
        print("within voicePipelineAgent: synthesis_handle: ", synthesis_handle)
    ...
    async def _main_task(self) -> None:
        ...
        def _on_playout_started() -> None:
            print("within voicePipelineAgent: _on_playout_started: ", )
        ...
        while True:
            ...
            while self._speech_q:
                ...
                print("within voicePipelineAgent: _main_task: ", speech)
    ...
    def _synthesize_agent_reply(self):
        ...
        print("within voicePipelineAgent: _synthesize_agent_reply: ", self)
        if self._pending_agent_reply is not None:
    ...
    async def _play_speech(self, speech_handle: SpeechHandle) -> None:
        ...
        print("within voicePipelineAgent: _play_speech: ", speech_handle)
        ...
        print("within voicePipelineAgent: _play_speech: ", play_handle)
    ...
    def _synthesize_agent_speech(
        ...
        print("within voicePipelineAgent: _synthesize_agent_speech: ", source)
        ...
        async def _llm_stream_to_str_generator(
            ...
            try:
                print("within voicePipelineAgent: _synthesize_agent_speech try: ", speech_id)
                async for chunk in stream:
                    print("within voicePipelineAgent: _synthesize_agent_speech stream : ", chunk)
                    if not chunk.choices:
                        continue
                    print("within voicePipelineAgent: _synthesize_agent_speech stream 2: ", speech_id)
                    content = chunk.choices[0].delta.content
                    if content is None:
                        continue
                    print("within voicePipelineAgent: _synthesize_agent_speech stream 3: ", speech_id)
                    yield content
            finally:
                await stream.aclose()
        ...
        try:
            print("within voicePipelineAgent: _synthesize_agent_speech try2  tts_source: ", tts_source)
