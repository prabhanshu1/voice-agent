...
class SynthesisHandle:
    ...
    def play(self) -> PlayoutHandle:
        ...
        print("within agent_output: play: ", self._play_handle)

        if self.interrupted:
            print("within agent_output: play interrupted: ")
...
class AgentOutput:
    ...
    def synthesize(
        ...
        *,
        ...
        print("within agent_output: synthesize: ", speech_id, tts_source, transcript_source, transcription, transcription_speed, sentence_tokenizer, word_tokenizer, hyphenate_word)
        def _before_forward(
            ...
            print("within agent_output: synthesize _before_forward: ", speech_id, tts_source, transcript_source, transcription, transcription_speed, sentence_tokenizer, word_tokenizer, hyphenate_word)

            return rtc_transcription
        print("within agent_output: synthesize 2: ", speech_id, tts_source, transcript_source, transcription, transcription_speed, sentence_tokenizer, word_tokenizer, hyphenate_word)
        ...
        print("within agent_output: synthesize after handle: ", speech_id, tts_source, transcript_source, transcription, transcription_speed, sentence_tokenizer, word_tokenizer, hyphenate_word)
